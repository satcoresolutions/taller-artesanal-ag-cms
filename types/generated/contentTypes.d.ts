...
export interface ApiMaterialGroupMaterialGroup
  extends Struct.CollectionTypeSchema {
...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    ...
    section: Schema.Attribute.Relation<
      'manyToOne',
      'api::product-section.product-section'
    >;
    seo: Schema.Attribute.Component<'shared.seo', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiProductSectionProductSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_sections';
  info: {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    allowBackorders: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    bestSeller: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    canReproduce: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    comparePriceCop: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    comparePriceUsd: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    craftYear: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    priceCop: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    relatedProducts: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    relatedTo: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    ...
    visibleGallery: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      ...
      Schema.Attribute.DefaultTo<true>;
    visibleStore: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::product-section.product-section': ApiProductSectionProductSection;
